...
public class AdapterCartItemLogged extends RecyclerView.Adapter<AdapterCartItemLogged.Viewholder>{

    private Context context;
    private ArrayList<ModelCartItem> cartItems;

    public AdapterCartItemLogged(Context context, ArrayList<ModelCartItem> cartItems) {
    ...
    @NonNull
    @Override
    public AdapterCartItemLogged.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterCartItemLogged.Viewholder holder, int position) {
        ...
        holder.itemRemoveTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double tx=Double.parseDouble((((BottomActivity)context).allTotalPriceTv.getText().toString().trim().replace("Shs","")));
                ...
                ((BottomActivity)context).allTotalPrice=0.00;
                ((BottomActivity)context).sTotalTv.setText("Shs"+String.format("%.2f",sTotalPrice));
                ((BottomActivity)context).allTotalPriceTv.setText("Shs"+String.format("%.2f",Double.parseDouble(String.format("%.2f",totalPrice))));
