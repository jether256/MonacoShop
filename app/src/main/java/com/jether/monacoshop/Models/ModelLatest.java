...
public class ModelLatest {
    ...
    public ModelLatest(String id, String imagee, String title, String product, String descc, String price, String quant, String image, String date, int sync_status) {
        this.id = id;
        this.imagee = imagee;
        this.title = title;
